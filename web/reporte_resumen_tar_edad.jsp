...
try{
    if (!conexion.isClosed()){
      ...
      rs_tar = st.executeQuery("SELECT '15-19' AS Edad, COUNT(*) AS Total, COUNT(if(Paciente.SexoID=1, 1, NULL)) AS Femenino, COUNT(if(Paciente.SexoID=2, 1, NULL)) AS Masculino "+
                            "FROM cohorte.Paciente "+
                            "WHERE EdadIngreso IS NOT NULL  "+
                            "        AND EdadIngreso >= 15  "+
                            "        AND EdadIngreso <=19 "+
...
<html>
    <head>
        ...
        &lt;![endif]-->
        <title>Reporte Pacientes Agrupados por Rango Edad al Ingreso a Centro</title>
    ...
    <body>
        ...
        <div id="content" class="left_content">
            <h1>Reporte Pacientes Agrupados por Rango Edad al Ingreso a Centro</h1>
            ...
            <div class="ui-datatable-tablewrapper">
                ...
                <thead id="j_idt85:tbl_head">
                    <tr role="row">
                        <th class="ui-state-default" role="columnheader"><span class="ui-column-title">Rango Edad</span></th>
            ...
            <%
                ...
                while (rs_tar.next()){
                    ...
                    out.println("<td>"+String.valueOf(rs_tar.getObject("Edad"))+"</td>");
