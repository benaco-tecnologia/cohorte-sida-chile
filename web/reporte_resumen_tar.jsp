...
try{
    if (!conexion.isClosed()){
      ...
      rs_tar = st.executeQuery("SELECT UPPER(Zona.Nombre) AS ZonaNombre, UPPER(Centro.ServicioSalud) AS ServicioSalud, UPPER(Centro.Nombre) AS CentroNombre, COUNT(*) AS Total, COUNT(if(Paciente.SexoID=1, 1, NULL)) AS Femenino, COUNT(if(Paciente.SexoID=2, 1, NULL)) AS Masculino "+
                                     ...
                                     "GROUP BY Zona.Nombre, Centro.ServicioSalud, Centro.Nombre, Centro.ID "+
...
<html>
    <head>
        ...
        &lt;![endif]-->
        <title>Reporte Pacientes Agrupados por Centro con Terapia Iniciada</title>
    ...
    <body>
        ...
        <div id="content" class="left_content">
            <h1>Reporte Pacientes Agrupados por Centro con Terapia Iniciada</h1>
            ...
            <div class="ui-datatable-tablewrapper">
                ...
                <thead id="j_idt85:tbl_head">
                    <tr role="row">
                        ...
                        <th class="ui-state-default" role="columnheader"><span class="ui-column-title">Paciente</span></th>
